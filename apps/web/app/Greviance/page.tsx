...
const Grievance = () => {
  ...
  <form className="bg-[rgb(94,213,183)] shadow-md px-8 pt-6 pb-8 mb-6 rounded-2xl text-center">
    <span className="text-2xl text-green-700 font-bold text-center mt-3">Grievance Report</span>
    ...
    <div className="mb-3">
      ...
      <input className="shadow appearance-none rounded-xl w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="twelvedid" type="date" placeholder="DD/MM/YYYY"/>
