...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 bg-[#06A67E]">
      ...
      <ul className="space-y-2 font-medium flex flex-col">
         <li className=''>
            <a href="#" className="flex pl-12 items-center p-2 text-center  text-gray-900 rounded-lg dark:text-black hover:scale-110 hover:shadow-lg dark:hover:shadow-black/30 group underline">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-center text-gray-900 rounded-lg dark:text-black  hover:scale-110 hover:shadow-lg dark:hover:shadow-black/30 group">
               <span className="flex-1 ml-3 whitespace-nowrap underline">Schemes</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-center text-gray-900 rounded-lg dark:text-black hover:scale-110 hover:shadow-lg dark:hover:shadow-black/30group">
